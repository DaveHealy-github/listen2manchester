...
T_END = 1500  # Length in seconds of data to plot after origin time
PHASES = ["P", "pP", "PP", "S"]   # list of phases to compute theoretical times for
#PHASES = ["P", "pP", "pPP", "PP", "PPP", "S", "Pdiff", "PKP", "PKIKP", "PcP", "ScP", "ScS", "PKiKP", "SKiKP", "SKP", "SKS"] # list of phases for which to compute theoretical times
