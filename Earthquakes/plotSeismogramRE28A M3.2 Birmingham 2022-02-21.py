...
axs.set_title("M3.2 Birmingham 2022-02-21 22:59 {:}.{:}.{:}.{:} - bandpass filter: {:}-{:} Hz".format(
...
plt.tight_layout() 
plt.savefig('plotRE28A Menai Bridge - M6.8 Fiji 2022-02-16.png', dpi=300)
