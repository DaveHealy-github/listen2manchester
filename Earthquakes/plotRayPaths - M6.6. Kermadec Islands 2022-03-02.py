...
STATION = "R3FEA"  # Station code of station to get data for
CHANNEL = "EHZ"  # channel to grab data for (e.g. EHZ, SHZ, EHE, EHN)
EQ_TIME = "2022-03-02T12:52:09"  # origin time of earthquake
...
EVT_LAT = -30.058  # Latitude of event
EVT_LON = 177.771  # Longitude of event 
EVT_Z = 36.2  # Depth of event
...
LABEL = "M6.6 Kermadec Islands on AM.R3FEA (Chorlton)"  # Title to plot on figure
