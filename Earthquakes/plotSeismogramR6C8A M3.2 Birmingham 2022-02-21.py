...
Flow = 0.5      # low corner frequency (Hz) for filter 
Fhigh = 2.      # high corner frequency (Hz) for filter 

#   now get some station meta data, esp. lat & long 
namStation1 = 'R6C8A'    #   MMU, Oxford Road Manchester   
netStation1 = 'AM'
locStation1 = '00'
...
axs.set_title("M6.6 Kermadec Islands 2022-03-02 12:52:09 {:}.{:}.{:}.{:} - bandpass filter: {:}-{:} Hz".format(
...
axs.set_xlim(19*60, 22*60)

plt.tight_layout() 
plt.savefig('plotR6C8A Oxford Road - M6.6 Kermadec Islands 2022-03-02.png', dpi=300)
