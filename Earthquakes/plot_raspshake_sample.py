...
EQ_TIME = "2020-10-19T20:54:40"  # origin time of earthquake
T_START = 0 # Length in seconds of data to plot before origin time
T_END = 60*100  # Length in seconds of data to plot after origin time
PHASES = ["P", "S"]   # list of phases to compute theoretical times for
EVT_LAT = +54.662  # Latitude of event
EVT_LON = -159.675  # Longitude of event 
EVT_Z = 40.1  # Depth of event
STA_LAT = 51.33  # Latitude of station  
STA_LON = -0.49  # Longitude of station
F1 = 0.01  # High-pass filter corner
F2 = 10.0 # Low-pass filter corner 
LABEL = "Alaska, 19 Oct 2020"  # Title to plot on figure
