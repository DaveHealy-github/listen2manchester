...
EQ_TIME1 = "2021-11-14T12:08:38"
latEvent1 = 27.736 
lonEvent1 = 56.077 
dtEvent1 = UTCDateTime(EQ_TIME1)
depEvent1 = 10 
sEventName1 = "Southern Iran M6.0 & M6.3 " + EQ_TIME1 
...
axs[1].set_ylim(-0.00075, 0.00075)
...
plt.tight_layout() 
plt.savefig('plotCompareRHSvBGS_Iran_v2.png', dpi=300)
