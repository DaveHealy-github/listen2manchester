...
STATION = "R36CB"  # Station code of station to get data for
...
PHASES = ["PKP"]   # list of phases to compute theoretical times for
EVT_LAT = -22.579  # Latitude of event
EVT_LON = 170.354  # Longitude of event 
EVT_Z = 10.  # Depth of event
STA_LAT = 53.3604  # Latitude of station  
STA_LON = -2.1889  # Longitude of station
F1 = 0.1  # High-pass filter corner
F2 = 0.8  # Low-pass filter corner 
LABEL = "M6.9 New Caledonia 2022-03-30 on AM.R36CB (Cheadle Hulme)"
