...
start = UTCDateTime("2022-09-01")
end = UTCDateTime("2022-09-15") # means "now"
datelist = pd.date_range(start.datetime, end.datetime, freq="D")

#   define the stations of interest 
network = "AM"
#station = "R72C7"   #  Aberdeen
#station = "R9E71"   #  RHS Bridgewater
#station = "R3FEA"   #  Chorlton   
#station = "R6055"   #  Amlwch 
#station = "RE28A"   #  Menai Bridge 
#station = "R6C8A"   #  MMU, Oxford Road 
station = "RA4D0"   #  Chorlton, Claude Road 
location = "00"
channel = "EHZ"
...
freqs = [(0.1,1.0),(1.0,20.0),(4.0,14.0),(4.0,20.0),(5.,20.)]
...
rs = d.copy().between_time("8:00", "20:00")
rs = rs.resample("1D" ).mean().tshift(12, "H")
plt.plot(rs.index, rs, label="$\overline{x}$ (08h-20h)", c='purple')
...
plt.savefig('plotAmbientWindowRA4D0_14days.png', dpi=300)
plt.show()
