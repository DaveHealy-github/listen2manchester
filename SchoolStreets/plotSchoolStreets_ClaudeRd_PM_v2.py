...
T_END = 60*30    #   60 mins the afternoon 
Flow = 15. 
Fhigh = 35. 
...
#   start of 'event' 
EQ_TIME = "2022-10-20T14:30:00"     # NB: time in UTC == GMT, not BST
...
#plt.setp(axs, xticks=[0, 300, 600, 900, 1200, 1500, 1800, 2100, 2400, 2700, 3000, 3300, 3600], 
#              xticklabels=['0', '5', '10', '15', '20', '25', '30', '35', '40', '45', '50', '55', '60'])
plt.setp(axs, xticks=[0, 300, 600, 900, 1200, 1500, 1800], 
              xticklabels=['0', '5', '10', '15', '20', '25', '30'])
plt.tight_layout() 
fn = namStation + '_SchoolStreets_Seismo_20Oct22_PM.png'
...
#data =  [12, 7, 5, 9, 8, 8, 9, 12, 12, 2, 8, 6] # 19Oct22 PM
data =  [10, 9, 5, 11, 9, 7] # 20Oct22 PM
...
plt.tight_layout() 
fn = namStation + '_SchoolStreets_Counts_20Oct22_PM.png'
plt.savefig(fn, dpi=300)
